...
open class BaseCircleImageView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet?,
    defStyleAttr: Int = 0
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        outlineProvider = BaseCircleImageViewOutlineProvider(strokeBounds)
    }
    ...
    class BaseCircleImageViewOutlineProvider(rectF: RectF) : ViewOutlineProvider() {
